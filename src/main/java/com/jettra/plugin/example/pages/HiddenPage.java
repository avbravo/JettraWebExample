...
public class HiddenPage extends DashboardBasePage {

    public HiddenPage() {
        super("Hidden Component Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "Hidden Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('hidden-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("hidden-code-modal");
        ...
        String javaCode = "import io.jettra.wui.core.annotations.Hidden;\n\n" +
                          ...
                          "}\n\n" +
                          "// En el UI Componente:\n" +
                          "TextBox hiddenBox = new TextBox(\"hidden\", \"internalId\");\n" +
                          "hiddenBox.setProperty(\"value\", \"secreto-123\");";
                          
        io.jettra.wui.core.UIComponent pre = new io.jettra.wui.core.UIComponent("pre") {};
        pre.setStyle("margin", "0");
        io.jettra.wui.core.UIComponent codeTag = new io.jettra.wui.core.UIComponent("code") {};
        codeTag.setProperty("id", "hidden-java-code");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('hidden-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        ...
        closeBtn.setProperty("onclick", "document.getElementById('hidden-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The @Hidden annotation is used to keep data in the model without showing it in the views. Alternatively, you can use a hidden TextBox directly.");
        container.add(p);

        container.add(new Header(3, "Hidden Field Example"));
        Div row1 = new Div();
        row1.setStyle("margin-bottom", "30px");
        
        row1.add(new Label("hidden_id", "Este campo es visible:"));
        TextBox visibleBox = new TextBox("text", "visible_field");
        visibleBox.setProperty("value", "Texto Visible");
        visibleBox.setStyle("display", "block").setStyle("margin-bottom", "10px");
        row1.add(visibleBox);
        
        row1.add(new Paragraph("A continuación hay un campo oculto que no se muestra en pantalla."));
        TextBox hiddenBox = new TextBox("hidden", "hidden_field");
        hiddenBox.setProperty("value", "valor_secreto_123");
        row1.add(hiddenBox);
