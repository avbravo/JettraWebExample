...
public class CatchaPage extends DashboardBasePage {

    public CatchaPage() {
        super("Catcha Component Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "Catcha Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('catcha-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        Modal codeModal = new Modal("catcha-code-modal");
        ...
        String javaCode = "Catcha catcha = new Catcha(\"form_verification\");\\n" +
                          "catcha.setAmountOfImagesToValidate(3);\\n" +
                          "catcha.setOnValidate(\"window.show3DMessage('Autenticado', 'Has aprobado la validación exitosamente');\");";
                          
        io.jettra.wui.core.UIComponent pre = new io.jettra.wui.core.UIComponent("pre") {};
        pre.setStyle("margin", "0");
        io.jettra.wui.core.UIComponent codeTag = new io.jettra.wui.core.UIComponent("code") {};
        codeTag.setProperty("id", "catcha-java-code");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('catcha-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('catcha-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The Catcha component offers a grid-based human verification interface seamlessly inside the WUI ecosystem.");
        container.add(p);
        ...
        catcha.setAmountOfImagesToValidate(3);
        catcha.setOnValidate("window.show3DMessage('Identity Verified', 'You manually selected 3 shapes explicitly.');");
        
        container.add(catcha);
