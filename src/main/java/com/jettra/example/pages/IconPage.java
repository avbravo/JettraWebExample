...
public class IconPage extends DashboardBasePage {
    ...
    protected void initCenter(Center center, String username) {
        ...
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("icon-code-modal");
        ...
        Paragraph p = new Paragraph("The Icon component.");
        container.add(p);
        ...
        Span i1 = new Span("⭐");
        i1.setStyle("font-size", "32px");
        Span i2 = new Span("❤️");
        i2.setStyle("font-size", "32px");
