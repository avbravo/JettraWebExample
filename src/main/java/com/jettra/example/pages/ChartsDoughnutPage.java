...
public class ChartsDoughnutPage extends DashboardBasePage {
    ...
    protected void initCenter(Center center, String username) {
        ...
        codeTag.setProperty("id", "chartsdoughnut-java-code");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('chartsdoughnut-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
