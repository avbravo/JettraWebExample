...
public abstract class DashboardBasePage extends Page {
    ...
    protected void setupLeft(Left left, String username) {
        ...
        addCategory(menuHtml, txtForms, new String[]{"Button", "CheckBox", "Form", "Forms", "RadioButton", "ScheduleControl", "SelectOne", "SelectOneIcon", "Spinner", "TextBox", "TextArea", "ToggleSwitch"}, menuClass, hoverEvents, categoryStyle, compIcon);
