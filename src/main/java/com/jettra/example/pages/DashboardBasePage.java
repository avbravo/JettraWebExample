...
public abstract class DashboardBasePage extends Page {
    ...
    protected void setupLeft(Left left, String username) {
        ...
        String[] components = {"Alert", "Avatar", "AvatarGroup", "Button", "Carousel", "CheckBox", "Clock", "Div", "Form", "Grid", "Header", "Icon", "Image", "Label", "Link", "LoginAdvanced", "Menu", "MenuBar", "Modal", "Notification", "Paragraph", "RadioButton", "SelectOne", "SelectOneIcon", "Separator", "SessionTimeout", "Span", "Table", "TextBox", "ToggleSwitch"};
