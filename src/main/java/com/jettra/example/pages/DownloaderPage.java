...
public class DownloaderPage extends DashboardBasePage {

    public DownloaderPage() {
        super("Downloader Component");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "Downloader Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('code-modal-downloader').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Code Modal Dialog for Java Code ---
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("code-modal-downloader");
        ...
        String javaCode = "Downloader dl = new Downloader(\"Download Document\", \"/files/doc.pdf\");\n" +
                          "dl.setFilename(\"manual.pdf\");\n" +
                          "center.add(dl);";
                          
        io.jettra.wui.core.UIComponent pre = new io.jettra.wui.core.UIComponent("pre") {};
        pre.setStyle("margin", "0");
        io.jettra.wui.core.UIComponent codeTag = new io.jettra.wui.core.UIComponent("code") {};
        codeTag.setProperty("id", "java-code-downloader");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('java-code-downloader').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('code-modal-downloader').style.display = 'none'");
        ...
        container.add(new Header(2, "Downloader Example").setStyle("margin-top", "30px"));
        container.add(new Paragraph("The Downloader component generates a button to start native file downloads. It uses HTML5 'download' attribute.").setStyle("margin-bottom", "20px"));
        
        Div row1 = new Div();
        row1.setStyle("margin-bottom", "30px");
        
        Downloader downloader = new Downloader("🚀 Download Sample Data", "data:text/plain;charset=utf-8,Hello%20World");
        downloader.setFilename("sample_data.txt");
