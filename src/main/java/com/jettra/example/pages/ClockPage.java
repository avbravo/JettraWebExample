...
import io.jettra.wui.components.Clock;
import io.jettra.wui.components.Button;

public class ClockPage extends DashboardBasePage {

    public ClockPage() {
        super("Clock Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "Clock Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('clock-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("clock-code-modal");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('clock-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('clock-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The Clock component to show live time.");
        container.add(p);
        ...
        Clock clock = new Clock("demo-clock");
