...
public class SelectOnePage extends DashboardBasePage {
    ...
    protected void initCenter(Center center, String username) {
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('select-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
