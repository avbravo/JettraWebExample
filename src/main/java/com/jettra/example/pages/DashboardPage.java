...
public class DashboardPage extends Page {
    ...
    public void initUI() {
        ...
        Top top = new Top();
        top.setContent("<h2>Jettra Global Dashboard</h2><div style='display:flex; align-items:center; gap:20px;'><span>Welcome, Admin</span><button class='j-btn' style='width:auto; padding:8px 15px; font-size:12px;' onclick='window.location.href=\"/\"'>Cerrar Sesión</button></div>");
