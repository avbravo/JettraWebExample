...
public class ToggleSwitchPage extends DashboardBasePage {

    public ToggleSwitchPage() {
        super("ToggleSwitch Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "ToggleSwitch Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('ts-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("ts-code-modal");
        ...
        String javaCode = "ToggleSwitch ts = new ToggleSwitch(\"themeToggle\", \"dark\", \"true\");\nts.setLabels(\"Dark\", \"Light\");\n\nToggleSwitch ts2 = new ToggleSwitch(\"wifiToggle\", \"wifi\", \"\");\nts2.setLabels(\"ON\", \"OFF\");";
                          
        io.jettra.wui.core.UIComponent pre = new io.jettra.wui.core.UIComponent("pre") {};
        pre.setStyle("margin", "0");
        io.jettra.wui.core.UIComponent codeTag = new io.jettra.wui.core.UIComponent("code") {};
        codeTag.setProperty("id", "ts-java-code");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('ts-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('ts-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The ToggleSwitch component.");
        container.add(p);
        ...
        ToggleSwitch ts = new ToggleSwitch("themeToggle", "dark", "true");
        ts.setLabels("Dark", "Light");
