...
public class CheckBoxPage extends DashboardBasePage {

    public CheckBoxPage() {
        super("CheckBox Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "CheckBox Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('cb-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("cb-code-modal");
        ...
        String javaCode = "CheckBox cb1 = new CheckBox(\"terms\", \"Accept Terms\", \"true\");\ncb1.setChecked(true);\n\nCheckBox cb2 = new CheckBox(\"subscribe\", \"Subscribe to Newsletter\", \"\");";
                          
        io.jettra.wui.core.UIComponent pre = new io.jettra.wui.core.UIComponent("pre") {};
        pre.setStyle("margin", "0");
        io.jettra.wui.core.UIComponent codeTag = new io.jettra.wui.core.UIComponent("code") {};
        codeTag.setProperty("id", "cb-java-code");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('cb-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('cb-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The CheckBox component.");
        container.add(p);
        ...
        CheckBox cb1 = new CheckBox("terms", "Accept Terms", "true");
        cb1.setProperty("checked", "checked");
        CheckBox cb2 = new CheckBox("subscribe", "Subscribe to Newsletter", "true");
        
        row1.add(cb1).add(cb2);
