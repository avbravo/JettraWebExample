...
public class BarCodePage extends DashboardBasePage {

    public BarCodePage() {
        super("BarCode Component Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "BarCode Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('barcode-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        Modal codeModal = new Modal("barcode-code-modal");
        ...
        String javaCode = "BarCode bc = new BarCode(\"product_barcode\");\\n" +
        ...
        codeTag.setProperty("id", "barcode-java-code");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('barcode-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('barcode-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The BarCode component generates crisp SVG barcodes dynamically scalable with multiple formats support.");
        container.add(p);
