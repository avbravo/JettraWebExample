...
public class TextBoxPage extends DashboardBasePage {

    public TextBoxPage() {
        super("TextBox Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "TextBox Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('tb-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("tb-code-modal");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('tb-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('tb-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The TextBox component for single-line text input.");
        container.add(p);
        ...
        TextBox tb = new TextBox("fullName", "");
        tb.setPlaceholder("Enter your name");
        tb.setStyle("padding", "8px").setStyle("border-radius", "4px").setStyle("border", "1px solid #ccc");
