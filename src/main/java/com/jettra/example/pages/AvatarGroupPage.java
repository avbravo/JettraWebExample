...
public class AvatarGroupPage extends DashboardBasePage {

    public AvatarGroupPage() {
        super("AvatarGroup Component");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "AvatarGroup Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('code-modal-avatargroup').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Code Modal Dialog for Java Code ---
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("code-modal-avatargroup");
        ...
        codeTag.setProperty("id", "java-code-avatargroup");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('java-code-avatargroup').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('code-modal-avatargroup').style.display = 'none'");
        ...
        container.add(new Header(2, "AvatarGroup Example").setStyle("margin-top", "30px"));
        container.add(new Paragraph("A stacked group of avatars representing a list of users.").setStyle("margin-bottom", "20px"));
        
        Div row1 = new Div();
        row1.setStyle("margin-bottom", "30px");
        
        AvatarGroup ag = new AvatarGroup();
        ag.add(Avatar.label("AB", "blue").setShape(Avatar.Shape.CIRCLE));
        ag.add(Avatar.label("CD", "red").setShape(Avatar.Shape.CIRCLE));
        ag.add(Avatar.label("EF", "green").setShape(Avatar.Shape.CIRCLE));
        ag.add(Avatar.label("GH", "purple").setShape(Avatar.Shape.CIRCLE));
