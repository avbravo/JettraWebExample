...
public class ParagraphPage extends DashboardBasePage {

    public ParagraphPage() {
        super("Paragraph Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "Paragraph Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('paragraph-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("paragraph-code-modal");
        ...
        String javaCode = "Paragraph p = new Paragraph(\"This is a standard paragraph showing text spanning multiple lines.\");\np.setStyle(\"color\", \"var(--jettra-text)\");";
                          
        io.jettra.wui.core.UIComponent pre = new io.jettra.wui.core.UIComponent("pre") {};
        pre.setStyle("margin", "0");
        io.jettra.wui.core.UIComponent codeTag = new io.jettra.wui.core.UIComponent("code") {};
        codeTag.setProperty("id", "paragraph-java-code");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('paragraph-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('paragraph-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The Paragraph component for text blocks.");
        container.add(p);
        ...
        Paragraph p1 = new Paragraph("JettraStack is a brilliant Java Web Framework avoiding the need for heavy front-end magic frameworks.");
