...
public class TextAreaPage extends DashboardBasePage {

    public TextAreaPage() {
        super("TextArea Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "TextArea Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('textarea-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("textarea-code-modal");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('textarea-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('textarea-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The TextArea component provides a multi-line text input field.");
        container.add(p);

        // --- Demo ---
        container.add(new Header(3, "Demo"));
        
        TextArea ta = new TextArea("demo-textarea", "This is a multi-line text area.\\nYou can write paragraphs here.");
        ta.setStyle("height", "200px").setStyle("background", "rgba(0,0,0,0.2)");
