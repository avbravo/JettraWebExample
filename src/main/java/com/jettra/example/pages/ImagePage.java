...
public class ImagePage extends DashboardBasePage {

    public ImagePage() {
        super("Image Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "Image Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('image-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("image-code-modal");
        ...
        codeTag.setProperty("id", "image-java-code");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('image-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('image-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The Image component displaying external or internal resources.");
        container.add(p);
        ...
        Image img = new Image("https://picsum.photos/300/200", "Image Demo");
        img.setStyle("border-radius", "8px").setStyle("box-shadow", "0 4px 6px rgba(0,0,0,0.1)");
