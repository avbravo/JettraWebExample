...
public class LabelPage extends DashboardBasePage {

    public LabelPage() {
        super("Label Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "Label Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('label-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        io.jettra.wui.complex.Modal codeModal = new io.jettra.wui.complex.Modal("label-code-modal");
        ...
        String javaCode = "Label lbl = new Label(\"usernameInput\", \"Username:\");";
                          
        io.jettra.wui.core.UIComponent pre = new io.jettra.wui.core.UIComponent("pre") {};
        pre.setStyle("margin", "0");
        io.jettra.wui.core.UIComponent codeTag = new io.jettra.wui.core.UIComponent("code") {};
        codeTag.setProperty("id", "label-java-code");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('label-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('label-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The Label component correlates to an input.");
        container.add(p);

        // --- Demo ---
        container.add(new Header(3, "Demo"));
        Div row1 = new Div();
        row1.setStyle("display", "flex").setStyle("gap", "20px").setStyle("align-items", "center").setStyle("margin-bottom", "30px");
        
        Label lbl = new Label("uname", "Username Field:");
        io.jettra.wui.components.TextBox tb = new io.jettra.wui.components.TextBox("username", "");
