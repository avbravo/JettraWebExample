...
public class QRPage extends DashboardBasePage {

    public QRPage() {
        super("QR Component Showcase");
    }
    ...
    protected void initCenter(Center center, String username) {
        ...
        Header h1 = new Header(1, "QR Component Showcase");
        ...
        codeBtn.setProperty("onclick", "document.getElementById('qr-code-modal').style.display = 'block'");
        headerRow.add(codeBtn);
        
        container.add(headerRow);
        
        // --- Modal Dialog for Java Code ---
        Modal codeModal = new Modal("qr-code-modal");
        ...
        String javaCode = "QR miQr = new QR(\"website_qr\");\\n" +
        ...
        codeTag.setProperty("id", "qr-java-code");
        ...
        copyBtn.setProperty("onclick", "navigator.clipboard.writeText(document.getElementById('qr-java-code').innerText).then(() => { this.innerText='Copied!'; setTimeout(() => this.innerText='Copy', 2000); })");
        
        Button closeBtn = new Button("Close");
        closeBtn.addClass("j-btn");
        closeBtn.setStyle("background", "transparent").setStyle("border-color", "var(--jettra-border)");
        closeBtn.setProperty("onclick", "document.getElementById('qr-code-modal').style.display = 'none'");
        ...
        Paragraph p = new Paragraph("The QR component integrates dynamic 2D barcodes into JettraWUI seamlessly.");
        container.add(p);
